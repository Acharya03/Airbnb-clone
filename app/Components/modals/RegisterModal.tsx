...
const RegisterModal = () => {
    ...
    const bodyContent = (
        <div className=" flex flex-col gap-4">
            ...
            <Input id="email" disabled={isLoading} register={register} errors={errors}
                required label={"Email"} />
            <Input id="name" disabled={isLoading} register={register} errors={errors}
                required label={"Name"} />
            <Input id="password" type="password" disabled={isLoading} register={register}
                errors={errors} required label={"Password"} />
        </div>
    )
