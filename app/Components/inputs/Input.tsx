...
const Input: React.FC<InputProps> = ({
  ...
  return (
    <div className=" w-full relative">
        ...
        className={`peer w-full p-4 pt-6 font-light bg-white border-[1px] rounded-md 
        outline-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed
